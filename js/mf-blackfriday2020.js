		...
		if(e.name !== "" && e.mail !== "" && e.tel !== ""){
		  if (e.mail.match(/[^@]+@[^@]+\.[^@]+/)){
		  	$.ajax({
		  	 ...
		  	 type: "PATCH",
		  	 url: "https://www.mariafilo.com.br/api/dataentities/BY/documents",
		  	 success: function(b) {
  ...
  var topbar = '<div class="topbarCountdown">\
    <div class="content">\
      <div class="topbarCountdown__countdown">\
          <div class="countdown" data-time="11-23-2020 00:01:00"></div>\
          <div class="titulo">para a nossa Black Friday antecipada</div>\
      </div>\
      <div class="topbarCountdown__infos">\
          <div class="info">\
              <div><p class="first">Descontos de até <strong>80%</strong></p></div>\
              <div class="space"><p><strong>Frete grátis</strong> em todo o site</p></div>\
              <div><p>Compre <strong>2 dias</strong> antes de todo mundo</p></div>\
          </div>\
      </div>\
  </div>\
  </div>';
